...
public class ConfirmacaoEnvio extends javax.swing.JFrame {
				...
				.setHorizontalGroup(
						jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								...
								.addGroup(jPanel1Layout.createSequentialGroup()
										...
										.addComponent(jButton1).addGap(38, 38, 38).addComponent(jButton2)
										.addGap(89, 89, 89)));
		jPanel1Layout
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(ConfirmacaoEnvio.class.getName()).log(java.util.logging.Level.SEVERE,
					null, ex);
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				new ConfirmacaoEnvio().setVisible(true);
			}
		});
	}
