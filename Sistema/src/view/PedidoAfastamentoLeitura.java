...
//    System.out.println(testando);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PedidoAfastamentoLeitura.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PedidoAfastamentoLeitura().setVisible(true);
            }
        });
    }
