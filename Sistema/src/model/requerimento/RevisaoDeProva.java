...
public class RevisaoDeProva extends Requerimento{
    ...
    public RevisaoDeProva(String requerente, String areaResponsavel, String status, String descricao, LocalDate dataCriacao, LocalDate dataSolucao, String feedback) {
